...
with window("Tools", no_collapse=True, no_resize=True, no_move=True, no_close=True, x_pos=0, y_pos=0, width=70, height=1370):
    ...
    add_spacing(count=1)
    add_image_button(name="rectangle tool", value="icons/rectangle-tool.png", width=45, height=45, frame_padding=5, tip="Rectangle tool (Under developement)")
    add_spacing(count=1)
    add_image_button(name="circle tool", value="icons/circle-tool.png", width=45, height=45, frame_padding=5, tip="Circle tool (Under developement)")
    add_spacing(count=1)
    add_separator()
    add_spacing(count=1)
